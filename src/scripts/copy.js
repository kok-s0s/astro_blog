;[...document.getElementsByTagName('pre')].forEach((item) => {
  ...
  copyButton.style.cssText =
    'position: relative; right: -0.5rem; top: -0.5rem; z-index: 555 !important; float: right; border-color: rgba(205,217,229,0.1); padding: 0; border-radius: 6px; cursor: pointer; background-color: #2e3440;'
  ...
  item.insertAdjacentElement('afterbegin', copyButton)
})
